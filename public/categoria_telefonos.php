...
<body>
    ...
    <div class="catalogo-container">
       ...
       // Asumiendo que el nombre de la categoría de teléfonos es 'telefonos' en la tabla 'categorias'
        $categoriaTelefono = 'telefonos';

        $query = "SELECT productos.* FROM productos JOIN categorias ON productos.id_categoria = categorias.id_categoria WHERE categorias.nombre = '$categoriaTelefono'";
